    ...
    <v-row>
      <v-col cols="12">
          ...
          >
            ...
            <v-card-text>
              <v-row dense>
                ...
                <v-col cols="6"><strong>Nota Primária:</strong> {{ transaction.primary_note ?? '—' }}</v-col>
                <v-col cols="6"><strong>Nota Secundária:</strong> {{ transaction.secondary_note ?? '—' }}</v-col>
            ...
            <v-card-actions>
              <v-btn color="blue" @click.stop="showEditForm(transaction)">Editar</v-btn>
            </v-card-actions>
          </v-card>
        </v-list>
        ...
        <TransactionForm
          ...
          :is-edit="!!selectedTransaction.id"
